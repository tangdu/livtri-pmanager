...
public class IHotelFlowSearchHotelsByIdWSFaultFaultMessage extends Exception {
    ...
    public IHotelFlowSearchHotelsByIdWSFaultFaultMessage(String message, com.livtrip.webservice.hotel.WSFault wsFault) {
        super(message);
        this.wsFault = wsFault;
    }

    public IHotelFlowSearchHotelsByIdWSFaultFaultMessage(String message, com.livtrip.webservice.hotel.WSFault wsFault, Throwable cause) {
        super(message, cause);
        this.wsFault = wsFault;
    }
