...
/**
 * <p>ArrayOfOccupancy complex type的 Java 类。
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Occupancy" type="{http://schemas.tourico.com/webservices/hotelv3}Occupancy" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ArrayOfOccupancy", propOrder = {
    "occupancy"
})
public class ArrayOfOccupancy {
