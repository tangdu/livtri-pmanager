...
public class IHotelFlowSearchHotelsByDestinationIdsWSFaultFaultMessage extends Exception {
    ...
    public IHotelFlowSearchHotelsByDestinationIdsWSFaultFaultMessage(String message, com.livtrip.webservice.hotel.WSFault wsFault) {
        super(message);
        this.wsFault = wsFault;
    }

    public IHotelFlowSearchHotelsByDestinationIdsWSFaultFaultMessage(String message, com.livtrip.webservice.hotel.WSFault wsFault, Throwable cause) {
        super(message, cause);
        this.wsFault = wsFault;
    }
