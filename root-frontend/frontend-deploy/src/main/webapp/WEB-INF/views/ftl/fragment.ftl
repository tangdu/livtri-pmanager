<fragment th:fragment="base_meta" th:remove="tag">
    <meta charset="utf-8"/>
...
<fragment th:fragment="base_css" th:remove="tag">
    ...
    <link rel="stylesheet" type="text/css" th:href="@{/resources/lib/Hui-iconfont/1.0.7/iconfont.css}" />
    <link rel="stylesheet" type="text/css" th:href="@{/resources/lib/icheck/icheck.css}" />
...
<fragment th:fragment="base_js" th:remove="tag">
    <!--[if lt IE 9]>
    <script type="text/javascript" th:src="@{/resources/lib/html5.js}"></script>
    <script type="text/javascript" th:src="@{/resources/lib/respond.min.js}"></script>
    <script type="text/javascript" th:src="@{/resources/lib/PIE_IE678.js}"></script>
    <![endif]-->

    <script type="text/javascript" th:src="@{/resources/lib/jquery/1.9.1/jquery.min.js}"></script>
    <script type="text/javascript" th:src="@{/resources/lib/layer/2.1/layer.js}"></script>
    <script type="text/javascript" th:src="@{/resources/h-ui/js/H-ui.js}"></script>
    <script type="text/javascript" th:src="@{/resources/h-ui.admin/js/H-ui.admin.js}"></script>
</fragment>

<fragment th:fragment="base_log" th:remove="tag">
...
<fragment th:fragment="base_navbar" th:remove="tag">
